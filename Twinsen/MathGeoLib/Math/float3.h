...
#endif
#ifdef MATH_IRRKLANG_INTEROP
    float3(const irrklang::math::float3df &other) : x(other.X), y(other.Y), z(other.Z) {}
    operator irrklang::math::float3df() const { return irrklang::math::float3df(x, y, z); }
#endif
};
